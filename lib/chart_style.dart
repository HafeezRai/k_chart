...
class ChartColors {
  ...
  static const Color ma10Color = Color(0xFF00C087);
  static const Color ma30Color = Color(0xff9979C6);
  static const Color upColor = Color(0xFF00C087);
  static const Color dnColor = Color(0xFFFF5252);
  ...
  static const Color deaColor = Color(0xFF00C087);
  static const Color kColor = Color(0xffC9B885);
  static const Color dColor = Color(0xFF00C087);
  ...
  //深度颜色
  static const Color depthBuyColor = Color(0xFF00C087);
  static const Color depthSellColor = Color(0xFFFF5252);
  //选中后显示值边框颜色
